This is a code to show how quicksort works on n(log(n)) for these is that required to graph the code using matplotlibcpp and is running on visual studio code
